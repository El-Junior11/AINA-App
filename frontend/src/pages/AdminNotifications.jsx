      ...
      <div className="bg-gradient-to-br from-emerald-50 to-sky-50 dark:from-emerald-950/20 dark:to-sky-950/20 border border-emerald-200/50 dark:border-emerald-900/40 rounded-2xl p-5">
        <div className="flex items-start gap-3">
          ...
          <div className="space-y-2 text-sm">
            ...
            <p className="text-emerald-800/90 dark:text-emerald-300/80">Sélectionnez les messages à supprimer ou à restaurer, ou utilisez « Sélectionner tout ». Cliquez sur un message pour afficher ses détails. Seules les traces de suppression peuvent être restaurées.</p>
          </div>
        </div>
      </div>
        ...
        <div className="px-4 md:px-5 py-3 border-b border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-800/70 flex flex-wrap items-center justify-between gap-3">
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            >
              ...
              {restoring?'Restauration...':'Restaurer la sélection'}
            </button>
                  ...
                  <div className="flex items-start gap-3 px-4 md:px-5 py-4">
                    ...
                    {log.action_type==='DELETE'&&(
                      <button
                        ...
                        className="mt-1 shrink-0 p-2 rounded-xl bg-emerald-50 hover:bg-emerald-100 dark:bg-emerald-950/30 dark:hover:bg-emerald-950/60 text-emerald-600 dark:text-emerald-400 border border-emerald-100 dark:border-emerald-900/40 transition-all"
                      >
                        <RotateCcw size={16}/>
                      </button>
                    )}
